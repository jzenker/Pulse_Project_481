<!--  Josephine Zenker modified from Lee Johnson's web tech class and David Gowans
        Shell of future work for the project. Currently not functional. Similar to insert.php script. 
 -->
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        $con = mysqli_connect("avl.cs.unca.edu", 'jzenker', 'sql4you', 'jzenkerDBTest')
                ...
                $query = "UPDATE heart_rate SET user_id='$id', hr_value='$hr', color='$color', WHERE user_id='$id' ";
